        ...
        for (int ikp = 0; ikp < nmatches; ikp++) {
            ...
            const cv::KeyPoint &kp1 =
                ...
                : (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight +
                    ...
                    ? mpCurrentKeyFrame->mvKeysSideLeft
                          [idx1 - mpCurrentKeyFrame->NLeft - mpCurrentKeyFrame->NRight]
                    : mpCurrentKeyFrame->mvKeysSideRight
                          [idx1 - mpCurrentKeyFrame->NLeft - mpCurrentKeyFrame->NRight -
                           mpCurrentKeyFrame->NSideLeft];
            ...
            if (mpCurrentKeyFrame->mpCamera2 && pKF2->mpCamera2) {
                ...
                if (mpCurrentKeyFrame->mpCamera3 && pKF2->mpCamera3 &&
                    mpCurrentKeyFrame->mpCamera4 && pKF2->mpCamera4) {
                        ...
                        for (map<KeyFrame *, tuple<int, int, int, int>>::const_iterator
                            ...
                            if (pKFi->NLeft == -1)
                                ...
                                if (sideleftIndex != -1) {
                                    int sideleftLevel =
                                        pKFi->mvKeysSideLeft
                                            [sideleftIndex - pKFi->NLeft - pKFi->NRight]
                                                .octave;
                                    scaleLeveli =
                                        (scaleLeveli == -1 || scaleLeveli > sideleftLevel)
                                            ? sideleftLevel
                                            : scaleLeveli;
                                }

                                if (siderightIndex != -1) {
                                    int siderightLevel = pKFi->mvKeysSideRight
                                                             [siderightIndex - pKFi->NLeft -
                                                              pKFi->NRight - pKFi->NSideLeft]
                                                                 .octave;
                                    scaleLeveli =
                                        (scaleLeveli == -1 || scaleLeveli > siderightLevel)
                                            ? siderightLevel
                                            : scaleLeveli;
                                }
                            }
