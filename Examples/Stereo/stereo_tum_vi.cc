    ...
    if (argc < 6) {
        cerr << endl
             << "Usage: ./stereo_tum_vi path_to_vocabulary path_to_settings "
                "path_to_image_folder1_1 path_to_image_folder2_1 path_to_times_file_1 "
                "(path_to_image_folder1_2 path_to_image_folder2_2 path_to_times_file_2 ... "
                "path_to_image_folder1_N path_to_image_folder2_N path_to_times_file_N) "
...
/*void LoadImages(const string &strPathLeft, const string &strPathRight, const string
&strPathTimes, vector<string> &vstrImageLeft, vector<string> &vstrImageRight, vector<double>
&vTimeStamps)
{
    ifstream fTimes;
